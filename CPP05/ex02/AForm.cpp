...
/*   Updated: 2025/04/14 22:10:48 by carmarqu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
AForm::AForm(std::string name, int gradeSign, int gradeExec) : _target(name), _signed(false), _gradeSign(gradeSign), _gradeExec(gradeExec)
{
...
AForm::AForm(const AForm &orig) : _target(orig._target), _gradeSign(orig._gradeSign), _gradeExec(orig._gradeExec)
{
    *this = orig;
